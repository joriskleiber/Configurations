...
#define CONFIG_EXAMPLES_DIR "Creality/Ender-3 Pro/CrealityV427/Sprite Extruder Pro + BLTouch"
...
#define STRING_CONFIG_H_AUTHOR "joris" // Original author or contributor.
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 424.0 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -30, -40, -1.2 } // (mm) X, Y, Z distance from Nozzle tip to Probe trigger-point
